...
export const initialTemplates: InvitationTemplate[] = [
  {
    ...
    description: 'An elegant and timeless design for weddings.',
  ...
  },
  {
    ...
    description: 'A stylish and contemporary design for birthdays.',
    ...
    layers: [
      ...
      { id: 'event-name', type: 'text', name: 'Event Name', value: "It's a Party!", x: 250, y: 60, width: 420, height: 80, fontFamily: 'font-headline', fontSize: 70, color: '#FFFFFF', textAlign: 'center', editable: true, fontWeight: 'normal' },
      { id: 'guest-of-honor', type: 'text', name: 'Guest of Honor', value: "You're invited to celebrate Leo's 30th Birthday", x: 250, y: 180, width: 420, height: 60, fontFamily: 'font-body', fontSize: 22, color: '#F5F5DC', textAlign: 'center', editable: true, fontWeight: 'normal' },
      { id: 'date-label', type: 'text', name: 'Date Label', value: 'Date', x: 145, y: 300, width: 200, height: 30, fontFamily: 'font-body', fontWeight: 'bold', fontSize: 18, color: '#D4A27A', textAlign: 'left', editable: false },
      { id: 'date-value', type: 'text', name: 'Date', value: '12.11.2024', x: 145, y: 330, width: 200, height: 30, fontFamily: 'font-body', fontSize: 18, color: '#FFFFFF', textAlign: 'left', editable: true, fontWeight: 'normal' },
      { id: 'time-label', type: 'text', name: 'Time Label', value: 'Time', x: 355, y: 300, width: 200, height: 30, fontFamily: 'font-body', fontWeight: 'bold', fontSize: 18, color: '#D4A27A', textAlign: 'left', editable: false },
      { id: 'time-value', type: 'text', name: 'Time', value: '8 PM until late', x: 355, y: 330, width: 200, height: 30, fontFamily: 'font-body', fontSize: 18, color: '#FFFFFF', textAlign: 'left', editable: true, fontWeight: 'normal' },
      { id: 'location-label', type: 'text', name: 'Location Label', value: 'Venue', x: 250, y: 400, width: 420, height: 30, fontFamily: 'font-body', fontWeight: 'bold', fontSize: 18, color: '#D4A27A', textAlign: 'center', editable: false },
      { id: 'location-value', type: 'text', name: 'Location', value: 'The Rooftop Bar, 123 Urban Ave', x: 250, y: 430, width: 420, height: 60, fontFamily: 'font-body', fontSize: 18, color: '#FFFFFF', textAlign: 'center', editable: true, fontWeight: 'normal' },
  ...
  },
  {
    ...
    description: 'A fun and whimsical design for baby showers.',
